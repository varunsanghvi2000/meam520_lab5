...
%attractive
[x,y,z] = sphere;
  rad_sph_attractive=30;
   spx_attractive=200;
   spy_attractive=130;
   spz_attractive=-50;
 hsphere2= surf(x*rad_sph_attractive+spx_attractive, y*rad_sph_attractive+spy_attractive, z*rad_sph_attractive+spz_attractive, 'facealpha', 0.8);
...
%ball
 [x,y,z] = sphere;
  rad_sph=15;
   ...
   spy=180;
   spz=-45;
 hsphere1= surf(x*rad_sph+spx, y*rad_sph+spy, z*rad_sph+spz);

hold off;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% set camera properties
axis([-100 350 -200 200 -200 300]);
view([150,14]);
count=0;
vsmooth = zeros();
...
while(1)
    ...
    if i == 0
        ...
        spy=spy+dir_step;
        set(hsphere1, 'XData',xhan*rad_sph+spx, 'YData',yhan*rad_sph+spy, 'ZData',zhan*rad_sph+spz);

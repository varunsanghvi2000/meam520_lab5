...
%
% input: q = 1x3 vector [q1, q2, q3] of joint angles (q1-q3)
% output: X = 4x3 matrix of values [x1 y1 z1; x2 y2 z2; ...] containing the
%             positions of each of the joints and the position of the end
%             effector
%         T = 4x4x3 matrix of transformation matrices, where each slice
